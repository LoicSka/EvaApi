...
child @users, :root => "result", :object_root => false do
  ...
  child :tutor_account, :object_root => false do
    attributes :id, :introduction, :gender, :dob, :district, :phone_number, :weibo_url, :wechat_url, :occupation, :days_available, :state, :renewed_at, :expiring_at, :created_at, :updated_at
