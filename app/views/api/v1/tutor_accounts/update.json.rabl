...
child @tutor_account, :if => @tutor_account.errors.empty?, :root => "result" do
  attributes :id, :introduction, :gender, :dob, :phone_number, :weibo_url, :wechat_url, :occupation, :days_available, :hourly_rate, :state, :renewed_at, :expiring_at, :created_at, :updated_at
