...
child @tutor_accounts, :root => "result", :object_root => false do
    attributes :id, :introduction, :gender, :phone_number, :occupation, :district, :weibo_url, :wechat_id, :certifications, :occupation, :days_available, :teaching_experience, :state, :renewed_at, :levels, :expiring_at, :country_of_origin, :created_at, :updated_at, :last_seen, :hourly_rate
